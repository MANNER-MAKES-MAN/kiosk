...
public class MenuDAO {
	...
	// 메뉴 이름으로 AudioGuide 파일명 반환
	 public String getAudioGuideByName(String menuName) {
	     String sql = "SELECT AudioGuide FROM Menu WHERE Name = ?";
	     ...
	     try (
	         ...
	         try (ResultSet rs = pstmt.executeQuery()) {
	             if (rs.next()) {
	                 return rs.getString("AudioGuide");
	             }
	         }
	     } catch (Exception e) {
	         e.printStackTrace();
